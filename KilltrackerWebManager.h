  ...
  private:
    ...
    JsonDocument readResponse(NetworkClient *client) {
      ...
      while (client->available()) {
        ...
        // Optionally print the headers (for debugging)
        // Serial.print("Header: ");
  ...
  public:
    ...
    void fetchKillcountTask(void *parameter) {
      while (true) {
        ...
        String getSteamUserRequestURL = "GET /steam_account/" + steam_id + footer;
        ...
        vTaskDelay(2000 / portTICK_PERIOD_MS); // Refresh every 1 ms
      }
    }
